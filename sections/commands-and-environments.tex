\begin{ParaColumn}[\section{Commands and Environments 命令与环境}]
    ...
    \CrossColumnText{
        \input{listings/switchcolumn-crosscolumn-example.tex}
    }
    ...
    \CrossColumnText{
        \input{listings/paracolumn-crosscolumn-example.tex}
    }
    ...
    \CrossColumnText{
        \input{listings/crosscolumn-command-example.tex}
    }
    ...
    \switchcolumn*[\subsection{Coss Reference 交叉引用}]
